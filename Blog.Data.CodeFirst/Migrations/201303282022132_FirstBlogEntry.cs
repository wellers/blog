        ...
        public override void Up()
        {
            Sql(@"
                ...
                '<div>
                    ...
                    <p>Some examples of syntactic sugar are detailed below.</p>
                </div>
                <div>
                    <br />
...
<pre class=""brush: csharp"">
    ...
    var ids = items.Select(x =&gt new { x.ID });</pre>
                </div>
                <div>
                    <br />
...
<pre class=""brush: csharp"">
    ...
    // or we can do this
    var person = new Person { ID = 1, Name = ""Paul"" };</pre>
                    <p>Collections can also be initialised, with their members set, using a similar syntax.</p>
<pre class=""brush: csharp"">
    ...
    var dictionary = new Dictionary&ltint, string&gt 
    {
        ...
        { 2, ""Bar"" } 
                ...
                <div>
                    <p>For my next post I may continue to expand on this post and go into other syntactic sugar features of Dot Net.</p>
                </div>',
                GETDATE()
            ");
        }
